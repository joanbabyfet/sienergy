...
<head>
    ...
    <title>{{ config('global.web.app_title') }} - 登入</title>
    <link rel="stylesheet" href="{{ WEB_CSS }}/sienergy/login.css" />
...
<div id="logincontainer">
    <div id="loginbox">
        <div id="loginheader">
            <img src="{{ WEB_IMG }}/hanboxLogoA.png" alt="Control Panel Login" />
    ...
    <img src="{{ WEB_IMG }}/login_fade.png" alt="Fade" />
</div>
