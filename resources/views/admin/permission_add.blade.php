<div class="layui-card-body ">
    <form id="layer-form" class="layui-form" action="{{ route("admin.permission.add") }}" method="POST">
        {{ csrf_field() }}
        <div class="layui-form-item">
            <label class="layui-form-label label-required-next">權限名稱:</label>
            <div class="layui-input-block">
                <input type="text" name="name" placeholder="請輸入權限名稱"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="display_name" placeholder="請輸入顯示名稱"
                       class="layui-input" required lay-verify="required">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="pg_id">
                    <option value=""></option>
                    {!! make_options($permission_groups) !!}
                </select>
            </div>
        </div>
{{--        <div class="layui-form-item">--}}
