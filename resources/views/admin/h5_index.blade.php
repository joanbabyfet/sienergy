    ...
    <div class="layui-card-body ">
        <script type="text/html" id="toolbar">
            <div class="layui-btn-container">
                <a class="layui-btn layui-btn-sm" onclick="admin.openLayerForm('{{ route("admin.h5.add") }}', 'H5添加', 'POST', '550px', '400px')"><i class="layui-icon"></i>新增</a>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="layui-btn layui-btn-xs"
                           onclick="admin.openLayerForm('{{ route("admin.h5.edit").'?id='.$v['id'] }}', 'H5編輯', 'POST', '550px', '400px')">編輯</a>
