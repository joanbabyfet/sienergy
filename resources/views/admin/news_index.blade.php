        ...
        <form class="layui-form layui-col-space5" id="search-form" method="GET">
            ...
            <div class="layui-inline layui-show-xs-block">
                <select name="cat_id" lay-verify="">
                    <option value=""></option>
                    {!! make_options($cats, request("cat_id")) !!}
                </select>
            </div>
            <div class="layui-inline layui-show-xs-block">
                ...
                <tr>
                    ...
                    <td>
                        <a class="layui-btn layui-btn-xs"
                           onclick="admin.openLayerForm('{{ route("admin.news.edit").'?id='.$v['id'] }}', '新聞編輯', 'POST', '600px', '350px')">編輯</a>
                        <a class="layui-btn layui-btn-xs layui-btn-danger"
                           onclick="admin.tableDataDelete('{{ route("admin.news.delete").'?ids[]='.$v['id'] }}', this)">刪除</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
            ...
            table.on('toolbar(list)', function(obj){
                ...
                switch(obj.event)
                {
                    ...
                    case 'export':
                        ...
                        _data.fields.push('create_user_dis');
                        export_excel('{{ route('admin.news.export_list') }}', _data, search_str);
                        break;
                }
            });
