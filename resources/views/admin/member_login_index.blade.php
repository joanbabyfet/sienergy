                ...
                <tr>
                    ...
                    <td>
                        <a class="layui-btn layui-btn-xs layui-btn-danger"
                           onclick="admin.tableDataDelete('{{ route("admin.member_login.delete").'?ids[]='.$v['_id'] }}', this)">刪除</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
            ...
            table.on('toolbar(list)', function(obj){
                ...
                switch(obj.event)
                {
                    case 'batch_del': //批量刪除
                        if(flag !== 0){
                            layui.layer.confirm('你確認刪除嗎？', {icon: 3, title: "提示", btn: ['確定', '取消']}, function (){
                                $.ajax({
                                    url: '{{ route('admin.member_login.delete') }}',
                                    type: 'POST',
                    ...
                    case 'export':
                        ...
                        export_excel('{{ route('admin.member_login.export_list') }}', _data, search_str);
                        break;
                }
            });
