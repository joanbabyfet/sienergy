    ...
    <div class="layui-card-body ">
        <form class="layui-form layui-col-space5" id="search-form" method="GET">
            <div class="layui-inline layui-show-xs-block">
                <input type="text" name="question" placeholder="請輸入問題" value="{{ request("question") }}" autocomplete="off"
                       class="layui-input">
            </div>
            <div class="layui-inline layui-show-xs-block">
    ...
    <div class="layui-card-body ">
        <script type="text/html" id="toolbar">
            <div class="layui-btn-container">
                <a class="layui-btn layui-btn-sm" onclick="admin.openLayerForm('{{ route("admin.faq.add") }}', '問答添加', 'POST', '500px', '350px')"><i class="layui-icon"></i>新增</a>
        ...
        <table id="list" lay-filter="list" style="display: none"
            ...
            <tr>
                ...
                <th lay-data="{field:'question', width: 350}">問題</th>
                ...
                <tr>
                    ...
                    <td>
                        <a class="layui-btn layui-btn-xs"
                           onclick="admin.openLayerForm('{{ route("admin.faq.edit").'?id='.$v['id'] }}', '問答編輯', 'POST', '500px', '350px')">編輯</a>
                        <a class="layui-btn layui-btn-xs layui-btn-danger"
                           onclick="admin.tableDataDelete('{{ route("admin.faq.delete").'?ids[]='.$v['id'] }}', this)">刪除</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
            ...
            table.on('toolbar(list)', function(obj){
                ...
                switch(obj.event)
                {
                    ...
                    case 'export':
                        ...
                        var _data = {fields:[]};
                        _data.fields.push('question');
                        export_excel('{{ route('admin.faq.export_list') }}', _data, search_str);
                        break;
                }
            });
