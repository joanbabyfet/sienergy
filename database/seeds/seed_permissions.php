...
class seed_permissions extends Seeder
{
    ...
    public function run()
    {
        ...
        $rows = [
            ...
            ['admin.link.index', 'admin', '友情鏈接列表', 15, $created_at],
            ['admin.link.add', 'admin', '友情鏈接添加', 15, $created_at],
            ['admin.link.edit', 'admin', '友情鏈接修改', 15, $created_at],
            ['admin.link.delete', 'admin', '友情鏈接刪除', 15, $created_at],
            ['admin.link.enable', 'admin', '友情鏈接啟用', 15, $created_at],
            ['admin.link.disable', 'admin', '友情鏈接禁用', 15, $created_at],
            ['admin.link.export_list', 'admin', '友情鏈接匯出', 15, $created_at],
